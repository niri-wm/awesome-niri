...
- [niri-pip](https://github.com/t1ktakdev/niri-pip) - Sticky Picture-in-Picture and floating-window control.
...
- [utsushot](https://github.com/xevrion/utsushot) - Supersampled Wayland screenshots via a temporary high-resolution phantom output.
...
- [Niri GTK](https://github.com/sameoldlab/niri-gtk) - GTK bindings to niri IPC.
